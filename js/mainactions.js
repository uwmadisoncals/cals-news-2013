...
$('.box[data-imagealign="middle"] img').css("position","absolute");
$('.box[data-imagealign="middle"] img').css("top","-40%");

$('.box[data-imagealign="bottom"] img').css("position","absolute");
$('.box[data-imagealign="bottom"] img').css("bottom","0px");
